...
export const PERMISSION_GROUPS: { id: string; column: 0 | 1 | 2; items: P[] }[] = [
  ...
  { id: 'dashboard', column: 2, items: [P.DASHBOARD_PAGE_VIEW, P.DASHBOARD_KPI_VIEW, P.DASHBOARD_CATEGORY_VIEW, P.DASHBOARD_NEAR_BREACH] },
  {
    id: 'settings',
    column: 2,
    items: [P.SETTINGS_SLA_VIEW, P.SETTINGS_SLA_EDIT, P.SETTINGS_STAFF_MANAGE, P.SETTINGS_DEPARTMENT_MANAGE, P.SETTINGS_TAG_MANAGE, P.SETTINGS_PRODUCT_MANAGE, P.SETTINGS_ROLE_MANAGE],
  },
