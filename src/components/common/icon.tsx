...
const shapes = {
  ...
  home: [
    ...
    <Path key="b" d="M5 9.8V20a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V9.8" />,
    <Path key="c" d="M9.5 21v-6h5v6" />,
  ],
  plusCircle: [<Circle key="a" cx="12" cy="12" r="9" />, <Path key="b" d="M8.5 12h7M12 8.5v7" />],
  cog: [
    <Circle key="a" cx="12" cy="12" r="3" />,
    <Path key="b" d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09a1.65 1.65 0 0 0-1.08-1.51 1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.6 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.6a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9c.14.35.4.63.73.8.3.15.63.22.96.2H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z" />,
  ],
  filter: [<Path key="a" d="M3 5h18l-7 8v6l-4 2v-8z" />],
  refresh: [<Path key="a" d="M21 12a9 9 0 1 1-2.64-6.36" />, <Path key="b" d="M21 3v6h-6" />],
